...
//////////////////////////////////////////////////////////////////////////////
  ...
  * @see TCPlanet#TCPlanet(SwissEph, int, int, double)
  * @see TCPlanetPlanet#TCPlanetPlanet(SwissEph, int, int, int, double)
  */
...
//  public static final String SE_EPHE_PATH=".:./ephe:/users/ephe2/:/users/ephe/:c\\:\\\\ephe:d\\:\\\\ephe:http\\://www.th-mack.de/datafiles";
  ...
  * @see SwissEph#swe_rise_trans(double, int, java.lang.StringBuffer, int, int, double[], double, double, swisseph.DblObj, java.lang.StringBuffer)
  */
  ...
  * @see SwissEph#swe_azalt(double, int, double[], double, double, double[], double[])
  */
  ...
  * long., xout[1]=&nbsp;ecl. lat..
  * @see SwissEph#swe_azalt_rev(double, int, double[], double[], double[])
  */
  ...
  * @see SwissEph#swe_refrac(double, double, double, int)
  * @see #SE_APP_TO_TRUE
  */
